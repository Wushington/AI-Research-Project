...
with open('data//FinalData.csv', 'w', newline='') as csvfile:
    ...
    csvwriter.writerow(['Homework', 'Project', 'Quiz', 'Exam', 'Final', 'Grade'])

    for row in combined.iterrows():
        currentRow = row[1]
        hw = (currentRow['HW01'] + currentRow['HW02'] + currentRow['HW03'] + currentRow['HW04'] + currentRow['HW05'] + currentRow['HW06']) / 6
        ...
        csvwriter.writerow([hw, proj, quiz, exam, final, letter])
